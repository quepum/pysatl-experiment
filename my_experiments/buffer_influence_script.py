...
def main():
    print(f"Starting {N_RUNS} runs for buffer_size={BUFFER_SIZE}...")
    with open(CSV_OUTPUT, "w", newline="", encoding="utf-8") as f:
        writer = csv.writer(f)
        writer.writerow(["run_id", "duration_sec"])
